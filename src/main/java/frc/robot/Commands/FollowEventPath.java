...
public class FollowEventPath extends InstantCommand {
  ...
  public FollowEventPath(PathPlannerTrajectory traj, DriveSubsystem driveSubsystem, boolean robotCentric) {
    trajectory = traj;
