...
public class SwerveModule {
  ...
  public SwerveModule(
    ...
    m_driveEncoder.setVelocityConversionFactor(ModuleConstants.kDriveEncoderDistancePerPulse * (1.0/60.0));
  ...
  public void resetEncoders() {
    ...
    m_turningEncoder.setPosition((((m_calibrateCANCoder.getAbsolutePosition() + 180) % 360) / 360));
